<template>
  <div class="userResearch">
    <div class="head">
      <div class="change">
        <div class="changeBorder">
          <span :class="{on: on===1}" @click="change(1)">详细指标趋势</span>
          <span :class="{on: on===2}" @click="change(2)">热门指标趋势</span>
        </div>
      </div>
    ...
    <div class="content">
      <div class="charts">
        <div class="title">
          <h3><i class="border-l"></i><span class="titleiner">产品各维度用户抱怨趋势分析</span></h3>
        </div>
        <div v-show="firstChartShow" class="chart clearfix">
          <div class="clearfix">
            <h4>一级量化指标<img src="../assets/images/qmark.png" alt=""></h4>
            <div class="listTitle">
        ...
        <div v-show="secondChartShow" class="chart clearfix">
          <div class="clearfix">
            <h4>二级量化指标<img src="../assets/images/qmark.png" alt=""></h4>
            <div class="listTitle">
              <span><img src="../assets/images/chart.jpg" alt="">图形</span>
              <i class="greyBorder"></i>
              <span><img src="../assets/images/tab.png" alt="">数据</span>
...
//      },
    ...
    mounted() {
      this.axios.post('http://10.168.99.88:8080/mockjs/99/promanage/ProPlan/PraiseAndPainTrend/Fig', {
        index_id: '1'
